...
#ifndef SUPPLIER_LIST_FORM
#define SUPPLIER_LIST_FORM
...
namespace POS {
	...
	private:
		void populateTable()
		{
			auto supplierId = Convert::ToString(static_cast<int>(Utils::roles::supplier));
			auto datatable = query->fetchData("SELECT NULL AS ID, NULL AS [Name], NULL AS Phone, NULL AS Email, NULL AS Address UNION SELECT userID, name, phone, email, address FROM Users WHERE roleId = " + supplierId);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(SupplierListForm::typeid));
			...
			this->table->Size = System::Drawing::Size(583, 300);
			this->table->TabIndex = 6;
			this->table->SelectionChanged += gcnew System::EventHandler(this, &SupplierListForm::table_SelectionChanged);
			// 
			// txtSearch
			// 
			...
			this->txtSearch->OnValueChanged += gcnew System::EventHandler(this, &SupplierListForm::txtSearch_OnValueChanged);
			// 
			// btnAdd
			// 
			...
			this->btnAdd->ButtonText = L"ADD SUPPLIER";
			...
			this->btnAdd->Location = System::Drawing::Point(328, 32);
			...
			this->btnAdd->Text = L"ADD SUPPLIER";
			...
			this->btnAdd->TextFont = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnAdd->Click += gcnew System::EventHandler(this, &SupplierListForm::btnAdd_Click);
			// 
			// btnDelete
			// 
			...
			this->btnDelete->Location = System::Drawing::Point(568, 32);
			...
			this->btnDelete->TextFont = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnDelete->Click += gcnew System::EventHandler(this, &SupplierListForm::btnDelete_Click);
			// 
			// btnEdit
			// 
			...
			this->btnEdit->Location = System::Drawing::Point(448, 32);
			...
			this->btnEdit->TextFont = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnEdit->Click += gcnew System::EventHandler(this, &SupplierListForm::btnEdit_Click);
			// 
			// Search
			// 
			...
			this->Search->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Search->Location = System::Drawing::Point(97, 60);
			...
			this->Activated += gcnew System::EventHandler(this, &SupplierListForm::SupplierListForm_Activated);
...
private: System::Void SupplierListForm_Activated(System::Object^ sender, System::EventArgs^ e) {
	populateTable();
}
...
private: System::Void txtSearch_OnValueChanged(System::Object^ sender, System::EventArgs^ e) {
	auto supplierId = Convert::ToString(static_cast<int>(Utils::roles::supplier));
	table->DataSource = query->fetchData("SELECT NULL AS ID, NULL AS [Name], NULL AS Phone,	NULL AS Email, NULL AS Address UNION SELECT userID, name, phone, email, address FROM Users WHERE roleId = " + supplierId + " AND(name LIKE'%+" + txtSearch->Text + "+%' OR email LIKE '%" + txtSearch->Text + "%' OR phone LIKE '%" + txtSearch->Text + "%' OR address LIKE '%" + txtSearch->Text + "%')");
}
...
private: System::Void btnEdit_Click(System::Object^ sender, System::EventArgs^ e) {
	if (!String::IsNullOrEmpty(Convert::ToString(table->CurrentRow->Cells[0]->Value)) && !isUpdated)
	{
		...
		isUpdated = true;
		auto form = gcnew SupplierForm(id, name, email, phone, address);
		form->Show();
	}
}
